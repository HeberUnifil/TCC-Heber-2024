...
A seguir constam as principais tecnologias aplicadas ao ambiente das finanças distribuídas, será apresentado brevemente seus respectivos contextos e utilizações.
...
\section*{Adoção Pública aos Criptoativos}
...
\section*{Inovação e Capitalização}

\textcolor{red}{cria um paragrafo introduzindo o que são essas inovações.}
