...
\titulo{Um Estudo Técnico das Criptomoedas e o Conceito de um Criptoativo no Ensino de Finanças} % Título da monografia
\autor{Heber José da Silva Junior} % Nome do autor
\instituicao{Centro Universitário Filadélfia}
\local{Londrina}
\data{2024} % Ano de publicação
\preambulo{Ciências da Computação} % Nome do curso
\orientador{Mario Henrique Akihiko da Costa Adaniya} % Nome do orientador
...
\include{./cap-problematica.tex}
\include{./cap-metodologia}
\include{./cap-resultados-esperados}
\include{./cap-estado-arte}
\include{./cap-fundament-teorica}
\include{./cap-cripto-educativo}
% \include{./cap-cronograma}
% \include{./cap-fichamento}
